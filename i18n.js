...
const I18N = {
  es: {
    ...
    faq_a_arrival: "La ceremonia comenzará puntualmente a las 5:00 PM. Sin embargo, les agradeceríamos llegar a las 4:30 PM para que podamos comenzar con la celebración de forma organizada.",
  ...
  en: {
    ...
    faq_a_arrival: "The ceremony will start promptly at 5:00 PM. However, we would appreciate it if you could arrive at 4:30 PM so we can start the celebration in an organized manner.",
